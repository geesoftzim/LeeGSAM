<%@ Page Title="" Language="C#" MasterPageFile="~/Root.master" AutoEventWireup="true" CodeBehind="ClientsCreationbak.aspx.cs" Inherits="LastTrialGene.ClientsCreationbak" %>
...
<asp:Content style="max-width: 100% !important; padding-left: 0px !important" ID="Content" ContentPlaceHolderID="PageContent" runat="server">
    ...
    <%--<dx:ASPxGridView ID="grid" runat="server" DataSourceID="GridViewDataSource" CssClass="grid-view"
     ...
     <dx:ASPxGridView ID="grid" runat="server"  CssClass="grid-view"
        KeyFieldName="ID"  AutoGenerateColumns="False" OnRowUpdating="grid_RowUpdating"
        Width="100%" OnRowInserting="grid_RowInserting">
        <Columns>
                ...
                <div style="padding: 4px 3px 4px">
                    <dx:ASPxPageControl runat="server" ID="pageControl" Width="100%">
                        <TabPages>
                            <dx:TabPage Text="Counterparty Details" Visible="true">
                                <ContentCollection>
                                    <dx:ContentControl runat="server">
                                      ...
                                      <%--<dx:ASPxGridViewTemplateReplacement ViewStateMode="Disabled" ID="Editors"  ReplacementType="EditFormEditors"
                                            runat="server"></dx:ASPxGridViewTemplateReplacement>--%>

                                        <div class="row">
                                            <div class="col-sm-4">
                                                <!-- text input  ReplacementType="EditFormEditors"-->
                                                <div class="form-group">
                                                    <div>
                                                        <dx:ASPxLabel ID="lblClientNumber" runat="server" Text="Client Number"></dx:ASPxLabel>
                                                        <dx:ASPxTextBox ID="txtClientNumber" runat="server" Text='<%# Bind("ID")%>' ClientInstanceName="txtPhoneNo"></dx:ASPxTextBox>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    <div>
                                                        ...
                                                        <dx:ASPxTextBox ID="txtclientno" Visible="false" runat="server" Text='<%# Bind("ClientNo")%>' ClientInstanceName="txtPhoneNo"></dx:ASPxTextBox>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-4">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <dx:ASPxTextBox ID="txtfirstName" runat="server" Text='<%# Bind("Name")%>' ClientInstanceName="txtPhoneNo"></dx:ASPxTextBox>
                                            ...
                                            <div class="col-sm-4">
                                                <div class="form-group">
                                                    ...
                                                    <dx:ASPxTextBox ID="txtIdentificationNo" runat="server" Text='<%# Bind("IdentificationNo")%>' ClientInstanceName="txtPhoneNo"></dx:ASPxTextBox>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-4">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <dx:ASPxTextBox ID="txtMiddleName1" runat="server" Text='<%# Bind("Name3")%>' ClientInstanceName="txtMiddleName1"></dx:ASPxTextBox>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-4">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <dx:ASPxTextBox ID="txtSurname" runat="server" Text='<%# Bind("Name2")%>' ClientInstanceName="txtSurname"></dx:ASPxTextBox>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-4">
                                                <div class="form-group">
                                                    ...
                                                    <dx:ASPxTextBox ID="txtGovRegNo" runat="server" Text='<%# Bind("GovRegNo")%>' ClientInstanceName="txtPhoneNo"></dx:ASPxTextBox>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-4">
                                                <!-- text input -->
                                                <div class="form-group">
                                                    <dx:ASPxLabel runat="server" ID="lblCountryOfResidence" Text="Country Of Residence"></dx:ASPxLabel>

                                                    <dx:ASPxComboBox ID="drpCountryOfResidence" runat="server" Caption="" ClientInstanceName="cboCitizenship" ValueField="ID" ValueType="System.Int32" TextField="Name" AutoPostBack="True" OnSelectedIndexChanged="cboCountry_SelectedIndexChanged">
                                                        <ValidationSettings>
                                                            <RequiredField ErrorText="Select CitizenShip" IsRequired="True" />
                                                        </ValidationSettings>
                                                    </dx:ASPxComboBox>
                            ...
                            <dx:TabPage Text="Contact Details" Visible="true">
                                ...
                                <ContentCollection>
                                    <dx:ContentControl runat="server">
                                        ...
                                        <%-- %> <dx:ASPxMemo runat="server" ID="notesEditor" Text='<%# Bind("ID")%>' Width="100%" Height="93px" />--%>
                                            ...
                                            <div class="col-sm-4">
                                                ...
                                                <div class="form-group">
                                                    <div>
                                                        ...
                                                        <dx:ASPxTextBox ID="txtPhoneNo1" runat="server" Text='<%# Bind("PhoneNo")%>' ClientInstanceName="txtPhoneNo"></dx:ASPxTextBox>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-sm-4">
                                                <div class="form-group">
                                                    ...
                                                    <dx:ASPxTextBox ID="txtEmailAddress" runat="server" Text='<%# Bind("EmailAddress")%>' Caption="" ClientInstanceName="txtPhoneNo"></dx:ASPxTextBox>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-4">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <dx:ASPxTextBox class="form-control" ID="txtPhoneNo2" runat="server" Text='<%# Bind("PhoneNo2")%>' Caption="" ClientInstanceName="txtPhoneNo"></dx:ASPxTextBox>
                                            ...
                                            <div class="col-sm-4">
                                                <div class="form-group">
                                                    ...
                                                    <dx:ASPxTextBox class="form-control" ID="txtFaxNo" runat="server" Text='<%# Bind("FaxNo")%>' Caption="" ClientInstanceName="txtPhoneNo"></dx:ASPxTextBox>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-4">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <dx:ASPxTextBox class="form-control" ID="txtMobileNo" runat="server" Text='<%# Bind("PhoneNo3")%>' Caption="" ClientInstanceName="txtPhoneNo"></dx:ASPxTextBox>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-4">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <dx:ASPxMemo class="form-control" ID="txtPhysicalAddressmemo" runat="server" Text='<%# Bind("PhysicalAddress")%>' Caption="" ClientInstanceName="txtPhoneNo"></dx:ASPxMemo>
                                                </div>
                                            </div>
                                            <div class="col-sm-4">
                                                <div class="form-group">
                                                    <dx:ASPxLabel ID="ASPxLabel12" runat="server" Text="Postal Address"></dx:ASPxLabel>
                                                    <dx:ASPxMemo class="form-control" ID="txtPostalAddressmemo" runat="server" Text='<%# Bind("PostalAddress")%>' Caption="" ClientInstanceName="txtPhoneNo"></dx:ASPxMemo>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-4">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <dx:ASPxMemo class="form-control" ID="txtPhysicalAddressmemo2" runat="server" Text='<%# Bind("PhysicalAddress2")%>' Caption="" ClientInstanceName="txtPhoneNo"></dx:ASPxMemo>
                                                </div>
                                            </div>
                                            <div class="col-sm-4">
                                                <div class="form-group">
                                                    <dx:ASPxLabel ID="ASPxLabel14" runat="server" Text="Postal Address"></dx:ASPxLabel>
                                                    <dx:ASPxMemo class="form-control" ID="txtPostalAddressmemo2" runat="server" Text='<%# Bind("PostalAddress2")%>' Caption="" ClientInstanceName="txtPhoneNo"></dx:ASPxMemo>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <%-- <ContentCollection>
                                   <dx:ContentControl runat="server">
                              <dx:ASPxTextBox ID="ASPxTextBox1" runat="server" Text='<%# Bind("PhoneNo2")%>' Caption="Phone No2"  ClientInstanceName="txtPhoneNo"></dx:ASPxTextBox>
                                    </dx:ContentControl>
                                </ContentCollection>

                                 <ContentCollection>
                                   <dx:ContentControl runat="server">
                                <dx:ASPxTextBox ID="txtEmailAddress" runat="server" Text='<%# Bind("EmailAddress")%>' Caption="EmailAdress"  ClientInstanceName="txtPhoneNo"></dx:ASPxTextBox>
                                    </dx:ContentControl>
                                </ContentCollection>

                                 <ContentCollection>
                                   <dx:ContentControl runat="server">
                                        <dx:ASPxTextBox ID="txtFaxNo" runat="server" Text='<%# Bind("txtFaxNo")%>' Caption="Fax No"  ClientInstanceName="txtPhoneNo"></dx:ASPxTextBox>
                                    </dx:ContentControl>
                                </ContentCollection>--%>
                            </dx:TabPage>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-4">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <dx:ASPxTextBox ID="txtZseAccountNumber" runat="server" Text='<%# Bind("ZSENumber")%>' Caption="" ClientInstanceName="txtPhoneNo"></dx:ASPxTextBox>
                                            ...
                                            <div class="col-sm-4">
                                                <div class="form-group">
                                                    ...
                                                    <dx:ASPxTextBox ID="txtVfxAccountNumber" runat="server" Text='<%# Bind("VFXNumber")%>' Caption="" ClientInstanceName="txtPhoneNo"></dx:ASPxTextBox>
                            ...
                            <dx:TabPage Text="Financial Declaratiom" Visible="true">
                                <ContentCollection>
                                    <dx:ContentControl runat="server">
                                        <div class="row">
                                            <div class="col-sm-6">
                                                <!-- text input -->
                                                <div class="form-group">
                                                    <dx:ASPxLabel runat="server" ID="ASPxLabel26" Text="Estimated Annual Sales"></dx:ASPxLabel>
                                                    <dx:ASPxTextBox ID="txtestfinancialsales" runat="server" Text="" Caption="" ClientInstanceName="txtPhoneNo"></dx:ASPxTextBox>

                                                </div>
                                            </div>
                                            <div class="col-sm-4">
                                                <div class="form-group">
                                                    <dx:ASPxLabel runat="server" ID="ASPxLabel27" Text="Estimated Trxn per/Month"></dx:ASPxLabel>
                                                    <dx:ASPxTextBox ID="txtexstEemmonth" runat="server" Text="" Caption="" ClientInstanceName="txtPhoneNo"></dx:ASPxTextBox>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-6">
                                                <!-- text input -->
                                                <div class="form-group">
                                                    <dx:ASPxLabel runat="server" ID="ASPxLabel28" Text="Anticipated  Trans per month"></dx:ASPxLabel>
                                                    <dx:ASPxTextBox ID="ASPxTextBox2" runat="server" Text="" Caption="" ClientInstanceName="txtPhoneNo"></dx:ASPxTextBox>

                                                </div>
                                            </div>
                                            <div class="col-sm-4">
                                                <div class="form-group">
                                                    <dx:ASPxLabel runat="server" ID="ASPxLabel29" Text="Anticipated Total Amount"></dx:ASPxLabel>
                                                    <dx:ASPxTextBox ID="ASPxTextBox3" runat="server" Text="" Caption="" ClientInstanceName="txtPhoneNo"></dx:ASPxTextBox>
                            ...
                            <dx:TabPage Text="Add Employment Details" Visible="true">
                                <ContentCollection>
                                    <dx:ContentControl runat="server">
                                        <div class="row">
                                            <div class="col-sm-4">
                                                ...
                                                <div class="form-group">
                                                    <div>
                                                        <dx:ASPxLabel ID="ASPxLabel6" runat="server" Text="Employer Name"></dx:ASPxLabel>
                                                        <dx:ASPxTextBox ID="txtEmployerName" runat="server" Text='<%# Bind("PhoneNo")%>' ClientInstanceName="txtPhoneNo"></dx:ASPxTextBox>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-sm-4">
                                                <div class="form-group">
                                                    <dx:ASPxLabel ID="ASPxLabel7" runat="server" Text="Postal Address"></dx:ASPxLabel>
                                                    <dx:ASPxMemo class="form-control" ID="txtEmpPostalAddress1" runat="server" Text='<%# Bind("PostalAddress")%>' Caption="" ClientInstanceName="txtPhoneNo"></dx:ASPxMemo>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-4">
                                                ...
                                                <div class="form-group">
                                                    <div>
                                                        <dx:ASPxLabel ID="ASPxLabel39" runat="server" Text="Physical Address"></dx:ASPxLabel>
                                                        <dx:ASPxMemo class="form-control" ID="ASPxMemo6" runat="server" Text='<%# Bind("PostalAddress")%>' Caption="" ClientInstanceName="txtPhoneNo"></dx:ASPxMemo>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-sm-4">
                                                <div class="form-group">
                                                    <dx:ASPxLabel ID="ASPxLabel40" runat="server" Text="Postal Address2"></dx:ASPxLabel>
                                                    <dx:ASPxMemo class="form-control" ID="ASPxMemo5" runat="server" Text='<%# Bind("PostalAddress")%>' Caption="" ClientInstanceName="txtPhoneNo"></dx:ASPxMemo>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-4">
                                                ...
                                                <div class="form-group">
                                                    <div>
                                                        <dx:ASPxLabel ID="ASPxLabel41" runat="server" Text="Physical Address2"></dx:ASPxLabel>
                                                        <dx:ASPxMemo class="form-control" ID="ASPxMemo7" runat="server" Text='<%# Bind("PostalAddress")%>' Caption="" ClientInstanceName="txtPhoneNo"></dx:ASPxMemo>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-sm-4">
                                                <div class="form-group">
                                                    <dx:ASPxLabel ID="ASPxLabel42" runat="server" Text="Country"></dx:ASPxLabel>
                                                    <dx:ASPxComboBox ID="cboEmpCountry" runat="server" Caption="" ClientInstanceName="cboCountry" ValueField="ID" ValueType="System.Int32" TextField="Name" AutoPostBack="True" OnSelectedIndexChanged="cboCountry_SelectedIndexChanged">
                                                        <ValidationSettings>
                                                            <RequiredField ErrorText="Select a country" IsRequired="True" />
                                                        </ValidationSettings>
                                                    </dx:ASPxComboBox>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-4">
                                                <!-- text input -->
                                                <div class="form-group">
                                                    <dx:ASPxLabel ID="ASPxLabel30" runat="server" Text="Phone No2"></dx:ASPxLabel>

                                                    <dx:ASPxTextBox class="form-control" ID="txtPhoneNo" runat="server" Text='<%# Bind("PhoneNo2")%>' Caption="" ClientInstanceName="txtPhoneNo"></dx:ASPxTextBox>

                                                </div>
                                            </div>
                                            <div class="col-sm-4">
                                                <div class="form-group">
                                                    <dx:ASPxLabel ID="ASPxLabel31" runat="server" Text="City"></dx:ASPxLabel>
                                                    <dx:ASPxComboBox ID="ASPxComboBox3" runat="server" Caption="" ClientInstanceName="cboCountry" ValueField="ID" ValueType="System.Int32" TextField="Name" AutoPostBack="True" OnSelectedIndexChanged="cboCountry_SelectedIndexChanged">
                                                        <ValidationSettings>
                                                            <RequiredField ErrorText="Select a country" IsRequired="True" />
                                                        </ValidationSettings>
                                                    </dx:ASPxComboBox>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-4">
                                                <!-- text input -->
                                                <div class="form-group">
                                                    <dx:ASPxLabel ID="ASPxLabel33" runat="server" Text="Phone Number2"></dx:ASPxLabel>
                                                    <dx:ASPxTextBox class="form-control" ID="txtPhoneNo3" runat="server" Text='<%# Bind("PhoneNo3")%>' Caption="" ClientInstanceName="txtPhoneNo"></dx:ASPxTextBox>

                                                </div>
                                            </div>
                                            <div class="col-sm-4">
                                                <div class="form-group">
                                                    <dx:ASPxLabel ID="ASPxLabel34" runat="server" Text="Alt Number"></dx:ASPxLabel>
                                                    <dx:ASPxTextBox class="form-control" ID="ASPxTextBox4" runat="server" Text='<%# Bind("PhoneNo3")%>' Caption="" ClientInstanceName="txtPhoneNo"></dx:ASPxTextBox>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-4">
                                                <!-- text input -->
                                                <div class="form-group">
                                                    <dx:ASPxLabel ID="ASPxLabel32" runat="server" Text="Work Email"></dx:ASPxLabel>
                                                    <dx:ASPxTextBox class="form-control" ID="ASPxTextBox5" runat="server" Text='<%# Bind("PhoneNo3")%>' Caption="" ClientInstanceName="txtPhoneNo"></dx:ASPxTextBox>

                                                </div>
                                            </div>
                                            <div class="col-sm-4">
                                                <div class="form-group">
                                                    <dx:ASPxLabel ID="ASPxLabel43" runat="server" Text="HR Email"></dx:ASPxLabel>
                                                    <dx:ASPxTextBox class="form-control" ID="ASPxTextBox7" runat="server" Text='<%# Bind("PhoneNo3")%>' Caption="" ClientInstanceName="txtPhoneNo"></dx:ASPxTextBox>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-4">
                                                <!-- text input -->
                                                <div class="form-group">
                                                    <dx:ASPxLabel ID="ASPxLabel35" runat="server" Text="Start of Employment"></dx:ASPxLabel>
                                                    <dx:ASPxDateEdit runat="server" ClientInstanceName="dteStartOfEmployment" ID="dteStartOfEmployment">
                                                        <%--<ValidationSettings>
                                                                <RequiredField IsRequired="True" ErrorText="Start of employment required"></RequiredField>
                                                            </ValidationSettings>--%>
                                                    </dx:ASPxDateEdit>
                                            ...
                                            <div class="col-sm-4">
                                                <div class="form-group">
                                                    <dx:ASPxLabel ID="ASPxLabel36" runat="server" Text="End of Employment"></dx:ASPxLabel>
                                                    <dx:ASPxDateEdit runat="server" ClientInstanceName="dteStartOfEmployment" ID="ASPxDateEdit1">
                                                        <%--<ValidationSettings>
                                                                <RequiredField IsRequired="True" ErrorText="Start of employment required"></RequiredField>
                                                            </ValidationSettings>--%>
                                                    </dx:ASPxDateEdit>
