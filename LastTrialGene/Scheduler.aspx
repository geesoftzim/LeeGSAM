<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Root.master" CodeBehind="Scheduler.aspx.cs" Inherits="LastTrialGene.SchedulerModule" Title="Scheduler" %>
...
<asp:Content ID="Content" ContentPlaceHolderID="PageContent" runat="server">
    ...
    <asp:ObjectDataSource ID="AppointmentDataSource" runat="server" DataObjectTypeName=" LastTrialGene.Model.SchedulerAppointment"
        TypeName=" LastTrialGene.Model.AppointmentDataSourceHelper"
    ...
    <asp:ObjectDataSource ID="ResourcesDataSource" runat="server" DataObjectTypeName=" LastTrialGene.Model.SchedulerResource"
        TypeName=" LastTrialGene.Model.ResourceDataSourceHelper"
