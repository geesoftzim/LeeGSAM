...
namespace LastTrialGene.Model {
    ...
    public class EmploymentDetails
    {
        ...
        /*public EmploymentDetails(int ClientID, string EmployerName, 
            string Address, string EmailAddress, string PhoneNo,string EmploymentDetailsID, int Country)
        {
        ...
        public EmploymentDetails(int ID, int ClientID, string EmployerName, string Address,
            string EmailAddress, string PhoneNo,
            string EmploymentDetailsID, int Country, int City)
        {
            this.id = ID;
            this.ClientID = ClientID;
            this.EmployerName = EmployerName;
    ...
    public class EmploymentDetailsResponse
    {
        ...
        public List<EmploymentDetails> data { get; set; }
    }
    ...
    public static class EmploymentDataProvider {
        static List<EmploymentDetails> l = new List<EmploymentDetails>();
        static ISet<EmploymentDetails> setq = new HashSet<EmploymentDetails>();
        static EmploymentDetails v = new EmploymentDetails();
        static string cliID = "";

        static void UpdateIssues(List<EmploymentDetails> list)
        {
            HttpContext.Current.Session["EmploymentDetails"] = list;
        }
        public static List<EmploymentDetails> GetEmployentdetails()
        {

            if (HttpContext.Current.Session["SelectedClientID"] != null)
            {
                cliID = HttpContext.Current.Session["SelectedClientID"].ToString();
                ...
                var webClient = new WebClient();
                {
                    ...
                    var url = "http://localhost:93/gsam/api/client/employment_list";

                    webClient.Headers.Add("user-agent", "Mozilla/4.0 (compatible; MSIE 6.0; Windows NT 5.2; .NET CLR 1.0.3705;)");
                    webClient.Headers[HttpRequestHeader.ContentType] = "application/json";
                    string data = JsonConvert.SerializeObject(CustomObject);
                    var response = webClient.UploadString(url, data);
                    var result = JsonConvert.DeserializeObject<EmploymentDetailsResponse>(response);
                    l = result.data;

                    // HttpContext.Current.Session["EmploymentDetails"] = l;
                    // foreach (var result1 in result.data)
                    // {
                    //     setq.Add(new EmploymentDetails(result1.id, result1.ClientID, result1.EmployerName, result1.Address, result1.EmailAddress, result1.PhoneNo, result1.EmploymentDetailsID,result1.Country,result1.City));
                    //  l.Add(new EmploymentDetails(result1.id, result1.ClientID, result1.EmployerName, result1.Address, result1.EmailAddress, result1.PhoneNo));
                    //  v = new EmploymentDetails(result1.id, result1.ClientID, result1.EmployerName, result1.Address, result1.EmailAddress, result1.PhoneNo);
                    // }
                    // l.Add(v);
                ...
                //========================
                //  if (HttpContext.Current.Session["EmploymentDetails"] == null)
                //  {
            ...
            l = new List<EmploymentDetails>();
            }
                    HttpContext.Current.Session["EmploymentDetails"] = l;
                    return HttpContext.Current.Session["EmploymentDetails"] as List<EmploymentDetails>;
            //    }
              //  else
            //    {
              //      return HttpContext.Current.Session["EmploymentDetails"] as List<EmploymentDetails>;
        ...
        private static readonly object lockObject = new object();
        public static void AddNewEmployerDetails(EmploymentDetails emp)
        {
            if (HttpContext.Current.Session["SelectedClientID"] != null)
            {
                //lock (lockObject)
               // {
                    ...
                    b.EmployerName = emp.EmployerName;
                    b.Address = emp.Address;
                    b.EmailAddress = emp.EmailAddress;
                    b.PhoneNo = emp.PhoneNo;
                    ...
                    try
                    {
                        ...
                        {
                            //webClient.BaseAddress = "http:localhost:93/gsam";
                            var url = "http://localhost:93/gsam/api/client/employment_create_update";
                            webClient.Headers.Add("user-agent", "Mozilla/4.0 (compatible; MSIE 6.0; Windows NT 5.2; .NET CLR 1.0.3705;)");
                            webClient.Headers[HttpRequestHeader.ContentType] = "application/json";
        ...
        public static void UpdateEmployerDetails(EmploymentDetails emp)
        {
            ...
            ////    EmploymentDetails existingIssue = emp.Find(i => i.Id == issue.Id);
              //  if (existingIssue != null) { }
                    //List<Issue> issues = GetIssues();
                    List<EmploymentDetails> empList = new List<EmploymentDetails>();
                ...
                b.ClientID = int.Parse(HttpContext.Current.Session["SelectedClientID"].ToString());//emp.ClientID;
                b.EmployerName = emp.EmployerName;
                b.Address = emp.Address;
                b.EmailAddress = emp.EmailAddress;
                b.PhoneNo = emp.PhoneNo;
                b.Country = emp.Country;
                b.EmploymentDetailsID = emp.id.ToString();
                b.Update = 1;
                b.Delete = 0;
