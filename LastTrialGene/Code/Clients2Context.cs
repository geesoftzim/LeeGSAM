...
namespace LastTrialGene.ClientsContext2
{
    ...
    public static class ClientsContext2
    {
        public static ClientDetailsData GetClients()
        {
            ...
            if (HttpContext.Current.Session["SelectedClientID"] != null  & SelectedCounterType==1)
            {
        ...
        public static Sex[] GetSex1()
        {
            Sex[] c = getParams().data.Sex;
        ...
        /**public static Identificationtype[] GetIdentification()
        {
            ...
            if (HttpContext.Current.Session["Identificationtype"] != null)
            {
                ...
                foreach (var elem in c)
                {
                    ...
                    var name = elem.Name;
                    var cor = elem.Corporate;

                    if (elem.IdentificationType.Equals(v))
                    {
                        c[0] = new Identificationtype(id, name,cor);
                    }
                }
            }
            return c;
        ...
        public static IEnumerable GetIdentification()
        {
            // Identificationtype[] c = getParams().data.IdentificationType;
            ...
            IEnumerable c = Array.FindAll(getParams().data.IdentificationType, ct => ct.Corporate == 1).ToArray();
            return c;
        }
        ...
        public static void NewClients(ClientDetailsDataUpdate1 emp)
        {
            ClientMDL newClient = new ClientMDL();
            {
               ...
               // newClient.BranchID = int.Parse(emp.BranchID.ToString());//int.Parse(cboBranch.Value.ToString()); //(@cboBranch.Value == null ? 0 : (int)cboBranch.Value);
            ...
            try
            {
                ...
                var webClient = new WebClient();
                {
                    ...
                    if (result.data != null)
                    {
                        HttpContext.Current.Session["InsertedMessage"] = result.message + "& Updated ClientID=" + result.data.ClientID;
                        WriteLogPost(data + " -----Message----" + result.message + "-----data---" + result.data.ClientID);

                    }
                    else
                    {
                        HttpContext.Current.Session["InsertedMessage"] = result.message + "& Updated ClientID=" + result.data;
        ...
        public static void UpdateClients(ClientDetailsDataUpdate1 emp)
        {
            ...
            ClientMDL newClient = new ClientMDL();
            {
               ...
               // newClient.InceptionDate = emp.InceptionDate.ToString();//DateTime.Now.ToString("yyyy-MM-dd");
                ...
                newClient.PostalAddress2 = emp.PostalAddress2;//postaAddress2.Text;
                newClient.PostalAddress3 = "";
                newClient.PostalCity = emp.PostalCity;// (@cboPostCity.Value == null ? 0 : (int)cboPostCity.Value);
                newClient.PostalCountry = emp.PostalCountry;// (cboPostCity.Value == null ? 0 : (int)cboPostCity.Value);
                newClient.PhoneNo = emp.PhoneNo;//phone.Text;
                newClient.PhoneNo2 = emp.PhoneNo2;//phone2.Text;
                newClient.PhoneNo3 = emp.PhoneNo3;//phone2.Text;
                newClient.FaxNo = "";
                ...
                newClient.IncomeTaxNo = emp.IncomeTaxNo;
            ...
            try
            {
                ...
                var webClient = new WebClient();
                {
                    ...
                    //    HttpContext.Current.Session["UpdateMessage"] = "success";
