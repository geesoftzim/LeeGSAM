     ...
     <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                <ContentTemplate>
                    ...
                    <dx:ASPxGridView ID="grdSearch" runat="server" AutoGenerateColumns="False" DataSourceID="dsSearch" Width="100%" EnableViewState="False" ClientInstanceName="grdSearch" OnFillContextMenuItems="grdSearch_FillContextMenuItems" OnContextMenuItemClick="grdSearch_ContextMenuItemClick" KeyFieldName="ID">
                        ...
                        <Columns>
                            <dx:GridViewDataTextColumn FieldName="ID" VisibleIndex="15"></dx:GridViewDataTextColumn>
                            ...
                            <dx:GridViewDataTextColumn FieldName="Name" Caption="Name" VisibleIndex="0"></dx:GridViewDataTextColumn>
                            ...
                            <dx:GridViewDataTextColumn FieldName="FaxNo" VisibleIndex="1" Visible="False"></dx:GridViewDataTextColumn>
